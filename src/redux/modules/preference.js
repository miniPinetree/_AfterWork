...
const getCollection = createAction(GET_COLLECTION, (collects)=>({collects}));
const likeToggle = createAction(LIKE_TOGGLE, (prd_id, is_like = false) => ({
    prd_id,
    is_like,
  }));
const deleteCollection = createAction(DELETE_COLLECTION,(collects)=>({collects}));
...
//찜 목록 전체삭제
const deleteCollectionDB=(id,location,offTime,interests)=>{
  return function(dispatch, getState, {history}){
